    ...
    <table class="table" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="buttons">
                    <a href="<?php echo e(route('nasabah.show', $nasabah->id)); ?>" class="btn btn-icon btn-info" ><i class="fas fa-info-circle"></i></a>
                    <a href="<?php echo e(route('nasabah.edit', $nasabah->id)); ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                    <form method="POST" action="<?php echo e(route('nasabah.destroy', $nasabah->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\foorstisla\resources\views/nasabah/index.blade.php ENDPATH**/ ?>