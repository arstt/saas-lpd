            ...
            <div class="card center">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-md" name="nama_nasabah" id="nama_nasabah" value="<?php echo e($alternative->nama_nasabah); ?>" disabled>
                        ...
                        <select class="form-control form-control-sm" id="kriteria[<?php echo e($kriteria->id); ?>]"
                            ...
                            <?php $__currentLoopData = $resource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cr->id); ?>"
                                    <?php echo e($cr->id == $alternativescores[$key]->bobot_id ? " selected=selected" : ""); ?>>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\foorstisla\resources\views/alternative/edit.blade.php ENDPATH**/ ?>