    ...
    <div class="card-header">
        ...
        <div class="card-body">
            <div class="section-body">
                ...
                <?php elseif($currentPlan->trial_ends_at): ?>
                    <div class="alert alert-info">Your trial will end on <?php echo e($currentPlan->subscriptions->trial_ends_at->toDateString()); ?> and your card will be charged.</div>
                    <br /><br />
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\forstisla\resources\views/billing/index.blade.php ENDPATH**/ ?>