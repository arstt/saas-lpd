<?php $__env->startSection('title', 'Matrix'); ?>
...
<div class="card">
    <div class="card-header">
        <h4><?php echo e('Decision Matrix'); ?></h4>
    </div>
    <!-- konten disini -->
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\foorstisla\resources\views/decision.blade.php ENDPATH**/ ?>