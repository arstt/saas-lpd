...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control number form-control-md" name="nilai_jaminan"
                            id="nilai_jaminan" value="<?php echo e(old('nilai_jaminan', '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control number form-control-md" name="nilai_pendapatan"
                            id="nilai_pendapatan" value="<?php echo e(old('nilai_pendapatan', '')); ?>">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\web\ardipa\resources\views/alternative/create.blade.php ENDPATH**/ ?>