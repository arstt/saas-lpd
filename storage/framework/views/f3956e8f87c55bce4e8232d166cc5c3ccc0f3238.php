    ...
    <table class="table" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($alternative->nasabah_id); ?></td>
                <?php
                ...
                <td>
                    <div class="buttons">
                        <a href="<?php echo e(route('alternatives.edit', $alternative->id)); ?>" class="btn btn-icon btn-primary"><i class="far fa-edit"></i></a>
                        <form method="POST" action="<?php echo e(route('alternatives.destroy', $alternative->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\foorstisla\resources\views/alternative/index.blade.php ENDPATH**/ ?>